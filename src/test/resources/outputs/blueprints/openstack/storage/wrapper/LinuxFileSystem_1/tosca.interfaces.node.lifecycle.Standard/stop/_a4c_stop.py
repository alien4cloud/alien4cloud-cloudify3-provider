...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_1/tosca.interfaces.node.lifecycle.Standard/stop/unmount.sh'), new_script_process, operationOutputNames)
