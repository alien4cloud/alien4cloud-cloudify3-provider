...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_2_CBS2/linuxPartitionCBS2/tosca.interfaces.relationship.Configure/pre_configure_source/fdisk.sh'), new_script_process, operationOutputNames)
