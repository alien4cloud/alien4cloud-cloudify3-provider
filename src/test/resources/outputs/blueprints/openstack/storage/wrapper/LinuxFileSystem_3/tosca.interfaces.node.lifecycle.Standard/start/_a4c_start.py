...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_3/tosca.interfaces.node.lifecycle.Standard/start/mount.sh'), new_script_process, operationOutputNames)
