...
env_map['FS_MOUNT_PATH'] = r'/var/cbs2'
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_2/tosca.interfaces.node.lifecycle.Standard/stop/unmount.sh'), new_script_process, operationOutputNames)
