...
env_map['A4C_EXECUTION_HOST'] = get_target_capa_or_node_attribute(ctx.source, 'requirements.host.ip_address', 'ip_address')
...
env_map['TARGET_component_version'] = r'2.4'
env_map['TARGET_port'] = r'80'
env_map['TARGET_document_root'] = r'/var/www'
env_map['TARGET_CAPABILITIES_host_num_cpus'] = ''
env_map['TARGET_CAPABILITIES_host_cpu_frequency'] = ''
env_map['TARGET_CAPABILITIES_host_disk_size'] = ''
env_map['TARGET_CAPABILITIES_host_mem_size'] = ''
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/wordpress_apache/wordpressHostedOnApacheApache/tosca.interfaces.relationship.Configure/pre_configure_source/config_wordpress.sh'), new_script_process, operationOutputNames, raiseException=raiseExceptionOnFailure)
