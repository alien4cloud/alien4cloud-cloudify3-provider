...
ctx.instance.runtime_properties['image'] = r'02ddfcbb-9534-44d7-974d-5cfd36dfbcab'
ctx.instance.runtime_properties['flavor'] = r'2'
ctx.instance.runtime_properties['user'] = r'ubuntu'

ctx.instance.runtime_properties['capabilities.scalable.min_instances'] = r'1'
ctx.instance.runtime_properties['capabilities.scalable.max_instances'] = r'1'
ctx.instance.runtime_properties['capabilities.scalable.default_instances'] = r'1'
ctx.instance.runtime_properties['capabilities.endpoint.secure'] = r'true'
ctx.instance.runtime_properties['capabilities.endpoint.protocol'] = r'tcp'
ctx.instance.runtime_properties['capabilities.endpoint.network_name'] = r'PRIVATE'
ctx.instance.runtime_properties['capabilities.endpoint.initiator'] = r'source'
ctx.instance.runtime_properties['capabilities.endpoint.ip_address'] = get_attribute(ctx, 'ip_address')
