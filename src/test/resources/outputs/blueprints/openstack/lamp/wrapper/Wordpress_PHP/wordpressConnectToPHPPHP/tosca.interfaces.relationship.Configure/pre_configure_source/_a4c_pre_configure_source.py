...
env_map['A4C_EXECUTION_HOST'] = get_target_capa_or_node_attribute(ctx.source, 'requirements.php.ip_address', 'ip_address')
...
env_map['TARGET_component_version'] = r'5'
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/wordpress_php/wordpressConnectToPHPPhp/tosca.interfaces.relationship.Configure/pre_configure_source/install_php_module.sh'), new_script_process, operationOutputNames, raiseException=raiseExceptionOnFailure)
