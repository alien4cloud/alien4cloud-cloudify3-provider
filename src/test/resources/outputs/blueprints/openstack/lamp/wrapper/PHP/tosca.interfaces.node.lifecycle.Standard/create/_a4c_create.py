...
env_map['SELF_component_version'] = r'5'
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/php/tosca.interfaces.node.lifecycle.Standard/create/install_php.sh'), new_script_process, operationOutputNames, raiseException=raiseExceptionOnFailure)
