...
relationship_artifacts = {
    "scripts": [
        {
            "relative_path": "stopSupp_hss.sh",
            "absolute_path": "_a4c_artifact/FileSystem/supp_to_volumeBlockStorage/scripts/scripts/stopSupp_hss.sh"
        }
        ,
        {
            "relative_path": "startSupp_hss.sh",
            "absolute_path": "_a4c_artifact/FileSystem/supp_to_volumeBlockStorage/scripts/scripts/startSupp_hss.sh"
        }
        ,
        {
            "relative_path": "deleteSupp_hss.sh",
            "absolute_path": "_a4c_artifact/FileSystem/supp_to_volumeBlockStorage/scripts/scripts/deleteSupp_hss.sh"
        }
        ,
        {
            "relative_path": "configureSupp_hss.sh",
            "absolute_path": "_a4c_artifact/FileSystem/supp_to_volumeBlockStorage/scripts/scripts/configureSupp_hss.sh"
        }
        ,
        {
            "relative_path": "relationships/supp_to_volume.sh",
            "absolute_path": "_a4c_artifact/FileSystem/supp_to_volumeBlockStorage/scripts/scripts/relationships/supp_to_volume.sh"
        }
        ,
        {
            "relative_path": "createSupp_hss.sh",
            "absolute_path": "_a4c_artifact/FileSystem/supp_to_volumeBlockStorage/scripts/scripts/createSupp_hss.sh"
        }
    ]
}
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/FileSystem_BlockStorage/supp_to_volumeBlockStorage/tosca.interfaces.relationship.Configure/pre_configure_source/supp_to_volume.sh'), new_script_process, operationOutputNames)
