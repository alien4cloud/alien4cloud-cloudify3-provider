...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/Java/tosca.interfaces.node.lifecycle.Standard/create/java_install.sh'), new_script_process, operationOutputNames)
