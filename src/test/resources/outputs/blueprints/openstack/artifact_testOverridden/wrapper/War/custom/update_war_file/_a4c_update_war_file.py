...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/War/custom/update_war_file/tomcat_install_war.sh'), new_script_process, operationOutputNames)
