...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/War/tosca.interfaces.node.lifecycle.Standard/create/create.sh'), new_script_process, operationOutputNames)
