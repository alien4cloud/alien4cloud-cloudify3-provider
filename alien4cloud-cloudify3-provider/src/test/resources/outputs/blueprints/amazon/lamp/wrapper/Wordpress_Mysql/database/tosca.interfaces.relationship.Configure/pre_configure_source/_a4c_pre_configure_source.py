...
env_map['A4C_EXECUTION_HOST'] = get_target_capa_or_node_attribute(ctx.source, 'requirements.database.ip_address', 'ip_address')
env_map['A4C_EXECUTION_USER'] = get_attribute_user(ctx.source)
env_map['A4C_EXECUTION_KEY'] = get_attribute_key(ctx.source)

env_map['DB_IP'] = get_target_capa_or_node_attribute(ctx.target, 'capabilities.database_endpoint.ip_address', 'ip_address')
env_map['DB_PORT'] = r'3306'
env_map['DB_NAME'] = r'wordpress'
env_map['DB_USER'] = r'pass'
env_map['DB_PASSWORD'] = get_secret('/my/password')
env_map['SELF_credential'] = ''
env_map['SOURCE_zip_url'] = r'https://wordpress.org/latest.zip'
env_map['SOURCE_context_root'] = r'/'
env_map['TARGET_port'] = r'3306'
env_map['TARGET_name'] = r'wordpress'
env_map['TARGET_db_user'] = r'pass'
env_map['TARGET_db_password'] = get_secret('/my/password')
env_map['TARGET_bind_address'] = r'true'
env_map['TARGET_storage_path'] = r'/mountedStorage'
env_map['TARGET_user'] = ''
env_map['TARGET_password'] = ''
env_map['TARGET_CAPABILITIES_database_endpoint_protocol'] = r'tcp'
env_map['TARGET_CAPABILITIES_database_endpoint_port'] = ''
env_map['TARGET_CAPABILITIES_database_endpoint_secure'] = r'false'
env_map['TARGET_CAPABILITIES_database_endpoint_url_path'] = ''
env_map['TARGET_CAPABILITIES_database_endpoint_port_name'] = ''
env_map['TARGET_CAPABILITIES_database_endpoint_network_name'] = r'PRIVATE'
env_map['TARGET_CAPABILITIES_database_endpoint_initiator'] = r'source'

other_instances_map = _all_instances_get_target_capa_or_node_attribute(ctx.target, 'capabilities.database_endpoint.ip_address', 'ip_address')
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/Wordpress_Mysql/database/tosca.interfaces.relationship.Configure/pre_configure_source/config_wordpress_for_mysql.sh'), new_script_process, operationOutputNames, raiseException=raiseExceptionOnFailure)
