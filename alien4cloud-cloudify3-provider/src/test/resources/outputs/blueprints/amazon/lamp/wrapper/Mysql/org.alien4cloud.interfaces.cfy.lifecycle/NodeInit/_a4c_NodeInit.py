...
ctx.instance.runtime_properties['port'] = r'3306'
ctx.instance.runtime_properties['name'] = r'wordpress'
ctx.instance.runtime_properties['db_user'] = r'pass'
ctx.instance.runtime_properties['db_password'] = get_secret('/my/password')
ctx.instance.runtime_properties['bind_address'] = r'true'
ctx.instance.runtime_properties['storage_path'] = r'/mountedStorage'

ctx.instance.runtime_properties['capabilities.database_endpoint.protocol'] = r'tcp'
ctx.instance.runtime_properties['capabilities.database_endpoint.secure'] = r'false'
ctx.instance.runtime_properties['capabilities.database_endpoint.network_name'] = r'PRIVATE'
ctx.instance.runtime_properties['capabilities.database_endpoint.initiator'] = r'source'
ctx.instance.runtime_properties['capabilities.database_endpoint.ip_address'] = get_attribute(ctx, 'ip_address')
