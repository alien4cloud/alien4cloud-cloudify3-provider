...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/apache/tosca.interfaces.node.lifecycle.Standard/create/install_apache.sh'), new_script_process, operationOutputNames, raiseException=raiseExceptionOnFailure)
