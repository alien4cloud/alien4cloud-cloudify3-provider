...
env_map['SELF_db_password'] = get_secret('/my/password')
env_map['SELF_user'] = ''
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/Mysql/tosca.interfaces.node.lifecycle.Standard/create/install_mysql.sh'), new_script_process, operationOutputNames, raiseException=raiseExceptionOnFailure)
