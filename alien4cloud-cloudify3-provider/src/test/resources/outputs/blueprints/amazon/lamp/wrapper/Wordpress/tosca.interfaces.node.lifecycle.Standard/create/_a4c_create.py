...
env_map['WEBFILE_URL'] = r'https://wordpress.org/latest.zip'
env_map['SELF_zip_url'] = r'https://wordpress.org/latest.zip'
env_map['SELF_context_root'] = r'/'
env_map['SELF_CAPABILITIES_app_endpoint_protocol'] = r'tcp'
env_map['SELF_CAPABILITIES_app_endpoint_port'] = ''
env_map['SELF_CAPABILITIES_app_endpoint_secure'] = r'false'
env_map['SELF_CAPABILITIES_app_endpoint_url_path'] = ''
env_map['SELF_CAPABILITIES_app_endpoint_port_name'] = ''
env_map['SELF_CAPABILITIES_app_endpoint_network_name'] = r'PRIVATE'
env_map['SELF_CAPABILITIES_app_endpoint_initiator'] = r'source'
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/Wordpress/tosca.interfaces.node.lifecycle.Standard/create/install_wordpress.sh'), new_script_process, operationOutputNames, raiseException=raiseExceptionOnFailure)
...
ctx.instance.runtime_properties['wordpress_url'] = r'http://' + get_attribute(ctx, 'public_ip_address') + r':' + r'80' + r'/'
ctx.instance.update()
