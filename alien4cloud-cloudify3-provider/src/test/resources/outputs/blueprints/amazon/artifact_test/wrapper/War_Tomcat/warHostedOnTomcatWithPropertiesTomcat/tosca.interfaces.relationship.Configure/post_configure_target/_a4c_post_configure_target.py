...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/War_Tomcat/warHostedOnTomcatWithPropertiesTomcat/tosca.interfaces.relationship.Configure/post_configure_target/configureProperties.sh'), new_script_process, operationOutputNames)
