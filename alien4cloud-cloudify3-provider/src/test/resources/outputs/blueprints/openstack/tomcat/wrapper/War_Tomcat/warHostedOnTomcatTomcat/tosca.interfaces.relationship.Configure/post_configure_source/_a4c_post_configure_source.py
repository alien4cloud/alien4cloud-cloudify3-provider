...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/War_Tomcat/warHostedOnTomcatTomcat/tosca.interfaces.relationship.Configure/post_configure_source/tomcat_install_war.sh'), new_script_process, operationOutputNames)
