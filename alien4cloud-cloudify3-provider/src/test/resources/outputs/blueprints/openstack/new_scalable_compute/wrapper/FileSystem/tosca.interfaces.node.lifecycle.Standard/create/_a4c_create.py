...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/FileSystem/tosca.interfaces.node.lifecycle.Standard/create/createSupp_hss.sh'), new_script_process, operationOutputNames)
