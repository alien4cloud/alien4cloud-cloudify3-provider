...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/Wordpress/tosca.interfaces.node.lifecycle.Standard/create/install_wordpress.sh'), new_script_process, operationOutputNames)
