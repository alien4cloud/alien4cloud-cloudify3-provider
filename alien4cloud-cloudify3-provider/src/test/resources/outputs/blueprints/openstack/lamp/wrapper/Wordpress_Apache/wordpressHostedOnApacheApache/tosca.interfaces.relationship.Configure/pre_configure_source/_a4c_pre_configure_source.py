...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/Wordpress_Apache/wordpressHostedOnApacheApache/tosca.interfaces.relationship.Configure/pre_configure_source/config_wordpress.sh'), new_script_process, operationOutputNames)
