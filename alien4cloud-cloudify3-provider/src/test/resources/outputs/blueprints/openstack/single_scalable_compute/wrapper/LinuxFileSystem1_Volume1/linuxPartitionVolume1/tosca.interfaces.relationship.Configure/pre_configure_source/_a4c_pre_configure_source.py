...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem1_Volume1/linuxPartitionVolume1/tosca.interfaces.relationship.Configure/pre_configure_source/fdisk.sh'), new_script_process, operationOutputNames)
