...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_1_CBS1/linuxPartitionCBS1/tosca.interfaces.relationship.Configure/post_configure_source/mkfs.sh'), new_script_process, operationOutputNames)
