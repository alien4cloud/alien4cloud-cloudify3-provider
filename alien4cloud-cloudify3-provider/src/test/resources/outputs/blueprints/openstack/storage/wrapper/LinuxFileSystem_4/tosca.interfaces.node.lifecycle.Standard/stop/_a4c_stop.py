...
env_map['FS_MOUNT_PATH'] = r'/var/cbs4'
...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_4/tosca.interfaces.node.lifecycle.Standard/stop/unmount.sh'), new_script_process, operationOutputNames)
