...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_4_CBS4/linuxPartitionCBS4/tosca.interfaces.relationship.Configure/post_configure_source/mkfs.sh'), new_script_process, operationOutputNames)
