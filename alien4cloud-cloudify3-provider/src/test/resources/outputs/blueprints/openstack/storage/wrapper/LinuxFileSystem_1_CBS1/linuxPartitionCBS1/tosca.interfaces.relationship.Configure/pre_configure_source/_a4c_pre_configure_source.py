...
parsed_output = execute(ctx.download_resource('_a4c_impl_artifact/LinuxFileSystem_1_CBS1/linuxPartitionCBS1/tosca.interfaces.relationship.Configure/pre_configure_source/fdisk.sh'), new_script_process, operationOutputNames)
